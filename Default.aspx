...
@media only screen and (max-width: 300px) {
  .text {font-size: 11px}
    ...
    <h1>
        Bienvenido a SupelKarros
    </h1>
    <p>
        Somos una empresa dominicana con pila de flow y un saco de piquete, y estamos a la orden para venderles los carros mas jevis de RD
    </p>
...
<div class="mySlides fade">
  ...
  <img src="/Images/1333.jpg" style="width:100%"/>
  <div class="text">BMW</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="/Images/Ford.jpg" style="width:100%"/>
  <div class="text">Ford</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="/Images/yotoya.jpg" style="width:100%"/>
  <div class="text">Toyota</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 4</div>
  <img src="/Images/Lambo.jpg" style="width:100%"/>
  <div class="text">Toyota</div>
</div>
